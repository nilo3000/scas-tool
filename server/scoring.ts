...
const ANSWER_SCORES: Record<string, Record<string, number>> = {
  ...
  activeMembersCount: {
    // Flat fallback — tier-specific overrides in TIER_ANSWER_SCORES below
  ...
  averageRevenuePerFan: {
    // Flat fallback; tier-specific overrides in TIER_ANSWER_SCORES below
    // Handles both old $ and new € answer values
    "<$5": 1.0, "$5-15": 2.0, "$15-40": 3.2, "$40-100": 4.2, "$100+": 5.0,
    "<2": 1.0, "2-5": 1.8, "5-15": 2.5, "15-40": 3.5, "40-80": 4.2, "80+": 5.0,
    "<5": 1.0, "40-100": 4.0, "100-200": 4.5, "200+": 5.0,
    "<10": 1.0, "10-30": 2.0, "30-80": 3.0, "80-200": 4.0, "200-400": 4.5, "400+": 5.0,
    "<30": 1.0, "30-80": 2.0, "200-500": 4.0, "500-1K": 4.5, "1K+": 5.0,
    "<80": 1.0, "80-200": 2.0, "500-1K": 3.5, "1K-3K": 4.5, "3K+": 5.0,
  },
  fanSegmentation: {
...
const TIER_ANSWER_SCORES: Record<string, Record<number, Record<string, number>>> = {
  ...
  activeMembersCount: {
    1: { "<50": 1.0, "50-200": 2.0, "200-500": 3.0, "500-2K": 3.8, "2K-5K": 4.5, "5K+": 5.0 },
    2: { "<200": 1.0, "200-1K": 2.0, "1K-3K": 3.0, "3K-8K": 3.8, "8K-20K": 4.5, "20K+": 5.0 },
    3: { "<1K": 1.0, "1K-5K": 2.0, "5K-15K": 3.0, "15K-40K": 3.8, "40K-100K": 4.5, "100K+": 5.0 },
    4: { "<5K": 1.0, "5K-20K": 2.0, "20K-60K": 3.0, "60K-150K": 3.8, "150K-300K": 4.5, "300K+": 5.0 },
    5: { "<20K": 1.0, "20K-75K": 2.0, "75K-200K": 3.0, "200K-500K": 3.8, "500K-2M": 4.5, "2M+": 5.0 },
  },
  seasonTicketRenewal: {
    // T2+ only (no T1)
  ...
  averageRevenuePerFan: {
    1: { "<2": 1.0, "2-5": 2.0, "5-15": 3.0, "15-40": 4.0, "40-80": 4.5, "80+": 5.0 },
    2: { "<5": 1.0, "5-15": 2.0, "15-40": 3.0, "40-100": 4.0, "100-200": 4.5, "200+": 5.0 },
    3: { "<10": 1.0, "10-30": 2.0, "30-80": 3.0, "80-200": 4.0, "200-400": 4.5, "400+": 5.0 },
    4: { "<30": 1.0, "30-80": 2.0, "80-200": 3.0, "200-500": 4.0, "500-1K": 4.5, "1K+": 5.0 },
    5: { "<80": 1.0, "80-200": 2.0, "200-500": 3.0, "500-1K": 4.0, "1K-3K": 4.5, "3K+": 5.0 },
  },
  sponsorCount: {
